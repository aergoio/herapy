...
#
AERGO_CONF_KEYS = {
    "base": ["datadir", "dbtype", "enableprofile", "profileport", "enablerest", "enabletestmode", "personal", ],
    "rpc": ["netserviceaddr", "netserviceport", "netservicetrace", "nstls", "nscert", "nskey", "nsallowcors", ],
    "rest": ["restport", ],
    "p2p": ["netprotocoladdr", "netprotocolport", "npbindaddr", "npbindport", "nptls", "npcert", "npkey", "npaddpeers", "nphiddenpeers", "npdiscoverpeers", "npmaxpeers", "nppeerpool", "npexposeself", "npusepolaris", "npaddpolarises", ],
    "polaris": ["allowprivate", "genesisfile", ],
    "blockchain": ["maxblocksize", "coinbaseaccount", "maxanchorcount", "usefastsyncer", "verifiercount", ],
