...
def test_op_mul() -> None:
    ...
    assert '249999999100000000810000000999999998.200000000000000001 aergo' == \
        aer.aergo
    assert '249999999100000000810000000999999998200000000.000000001 gaer' == \
        aer.gaer
    assert '249999999100000000810000000999999998200000000000000001 aer' == \
        aer.aer
